...
macro_rules! for_each_uart {
    ($($pattern:tt => $code:tt;)*) => {
        ...
        _for_each_inner_uart!((2, UART2, Uart2, U2RXD, U2TXD, U2CTS, U2RTS, U2DTR));
        _for_each_inner_uart!((all(0, UART0, Uart0, U0RXD, U0TXD, U0CTS, U0RTS, U0DTR), (1,
        UART1, Uart1, U1RXD, U1TXD, U1CTS, U1RTS, U1DTR), (2, UART2, Uart2, U2RXD, U2TXD, U2CTS,
        U2RTS, U2DTR)));
    };
}
